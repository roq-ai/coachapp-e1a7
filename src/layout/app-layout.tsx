...
const SidebarContent = ({ onClose, ...rest }: SidebarProps) => {
  ...
  const LinkItems: Array<LinkItemProps> = [
    ...
    { name: 'Event', path: '/events', entity: 'event', service: AccessServiceEnum.PROJECT, icon: FiAward },
    {
      name: 'Swim Meet',
      path: '/swim-meets',
      entity: 'swim_meet',
    ...
    { name: 'Team', path: '/teams', entity: 'team', service: AccessServiceEnum.PROJECT, icon: FiFlag },
    {
      name: 'Training Plan',
      path: '/training-plans',
