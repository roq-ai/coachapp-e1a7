...
import { getSwimMeetById } from 'apiSdk/swim-meets';
      ...
      <Box bg="white" p={4} rounded="md" shadow="md">
        <Flex justifyContent="space-between" mb={4}>
          <Text as="h1" fontSize="2xl" fontWeight="bold">
            Swim Meet Detail View
          </Text>
          {hasAccess('swim_meet', AccessOperationEnum.UPDATE, AccessServiceEnum.PROJECT) && (
            <NextLink href={`/swim-meets/edit/${data?.id}`} passHref legacyBehavior>
              <Button
              ...
              {hasAccess('event', AccessOperationEnum.READ, AccessServiceEnum.PROJECT) && (
                <Stack spacing={2} mb={8}>
                  <Flex justifyContent="space-between">
                    ...
                    <NextLink passHref href={`/events/create?swim_meet_id=${data?.id}`}>
