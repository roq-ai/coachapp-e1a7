          ...
          <TableContainer>
            <Table variant="simple">
              <Thead>
                <Tr>
                  <Th>name</Th>
                  {hasAccess('swim_meet', AccessOperationEnum.READ, AccessServiceEnum.PROJECT) && <Th>swim_meet</Th>}
              ...
              <Tbody>
                {data?.map((record) => (
                  <Tr cursor="pointer" onClick={() => handleView(record.id)} key={record.id}>
                    <Td>{record.name}</Td>
                    {hasAccess('swim_meet', AccessOperationEnum.READ, AccessServiceEnum.PROJECT) && (
                      <Td>
                        <Link as={NextLink} href={`/swim-meets/view/${record.swim_meet?.id}`}>
                          {record.swim_meet?.name}
                        </Link>
                      </Td>
                    )}
